...
#DON'T FORGET TO GIVE CREDIT TO FLAME TUTUL
...
def main():
	...
	print("\t\033[93;1m      TUTUL MENU\x1b[0m")
...
def menu():
    ...
    print("\033[93;1m     FLAME TUTUL : \033[92;1m"+xn)
...
def crack_select1():
	...
	if select =="1":
		...
		print("\t\033[92;1m FLAME TUTUL PUBLIC ID COINING ")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									print(" \033[1;33m[TUTUL-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[TUTUL-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													print(" \033[1;33m[TUTUL-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m[TUTUL-CP] "+uid+" | "+pass6+"\033[0;97m")
	...
	print("\033[92;1m FLAME TUTUL HACKING HAS BEEN COMPLETED")
